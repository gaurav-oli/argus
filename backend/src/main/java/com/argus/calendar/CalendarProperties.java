 ...
 * @param earningsLookbackDays how many days into the past Finnhub's earnings call also covers, so a
 *                             date ingested before it reported gets revisited once actual/estimate EPS
 *                             is available (Story: earnings beat/miss)
...
public record CalendarProperties(
		...
		@DefaultValue("30") int earningsLookbackDays,
